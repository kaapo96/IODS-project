...
# create a vector where 1 = male and 2 = female
genders <- NA
genders[learning2014$gender == "M"] <- 1
genders[learning2014$gender == "F"] <- 2
genders <- as.numeric(genders)

# draw a scatter plot matrix of the variables in learning2014.
# [-1] excludes the first column (gender)
pairs(learning2014[-1], col = c("blue", "red")[genders])
