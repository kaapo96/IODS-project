...
In all of the four cases, the data seems to support my hypotheses at least by visually inspecting the distributions. Let's approach the analysis more systematically and try to further solidify the hypotheses by using logistic regression to find statistically significant relationships between alcohol consumption (target variable) and the four variables. Fitting a logistic regression model to the data yields
